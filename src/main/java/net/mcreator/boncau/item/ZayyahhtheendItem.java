...
import net.mcreator.boncau.world.dimension.ZayyahhtheendDimension;
import net.mcreator.boncau.itemgroup.DiariteModItemGroup;

public class ZayyahhtheendItem extends Item {
	@ObjectHolder("boncau2:zayyahhtheend")
	public static final Item block = null;

	public ZayyahhtheendItem() {
	...
	public ActionResultType onItemUse(ItemUseContext context) {
		...
		if (!entity.canPlayerEdit(pos, context.getFace(), itemstack)) {
			...
			if (world.isAirBlock(pos) && true) {
				ZayyahhtheendDimension.portal.portalSpawn(world, pos);
